...
<script type="text/javascript">
    ...
    var displayName4="Temperature";
    var units4="&#8451";

    var typeParameter5="humidity";
    var displayName5="Humidity";
    var units5="%";

    var typeParameter3="open";
    var displayName3="Locker Open";
    var units3="";

    var typeParameter1="metal";
    var displayName1="Metal";
    var units1="";

    var typeParameter2="occupancy";
    var displayName2="Occupancy";
    var units2="";
